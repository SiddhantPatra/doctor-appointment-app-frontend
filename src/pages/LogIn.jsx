...
import { MobileLoginBro } from "../assets/images";
  ...
  return (
    <main>
      ...
      <section className=" padding-b pt-48  ">
        <div className="flex flex-1 flex-row max-sm:flex-col-reverse justify-center bg-loginCard max-sm:mx-4 ">
          ...
          <div className=" flex flex-1 items-center  justify-center max-sm:mx-4 ">
            <div className="w-full  bg-green-100 bg-opacity-25 rounded-xl shadow-lg p-8 my-4 md:max-w-sm md:mx-auto ">
              <span className="block w-full  text-xl uppercase font-bold mb-4 font-montserrat">
                <span className="text-teal-800 ">Hello !!!👋 </span>Welcome
                Back.
              </span>
              <form className="mb-4 " action="/" method="post">
                ...
                {/* <button type="submit" onClick={handleOnSubmit} className="bg-green-500 hover:bg-green-700 text-white uppercase text-sm font-semibold px-4 py-2 rounded">
                  Login
                </button> */}
                <button
